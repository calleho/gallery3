	...
	PhotoSwipe.Image.ImageClass = klass({
		...
		initialize: function(refObj, src, caption, metaData){
			...
			if (metaData.type == "video") {
				this.imageEl = document.createElement('video');
				this.imageEl.controls = true;
				this.imageEl.width = Util.DOM.windowWidth();
				this.imageEl.height = Util.DOM.windowHeight() * 0.8;
			} else {
		...
		load: function(){
			...
			if (this.metaData.type == "video") {
				this.imageEl.poster = this.metaData.thumburl + '_' + Math.floor(Math.random()*11);
				this.imageEl.naturalWidth = 300;
				this.imageEl.naturalHeight = 150;
				this.imageEl.src = this.imageEl.src + '_' + Math.floor(Math.random()*11);
				this.imageEl.originalSrc = this.imageEl.src;
			}
...
(function(window, klass, Util){
	...
	PhotoSwipe.Carousel.CarouselClass = klass({
		...
		addCacheImageToItemEl: function(cacheImage, itemEl){
			...
			if (cacheImage.metaData.type != "video") {
